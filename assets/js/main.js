...
jQuery(document).ready(function($) {
    ...
    $('#circle1').circleProgress({
      ...
      $(this).find('strong').html('<img src="assets/icon/kotlin-svgrepo-com.svg">');
  });
    ...
    $('#circle2').circleProgress({
      ...
      $(this).find('strong').html('<img src="assets/icon/java-svgrepo-com.svg">');
  });
    ...
    $('#circle3').circleProgress({
      ...
      $(this).find('strong').html('<img src="assets/icon/laravel-svgrepo-com.svg">');
  });
    ...
    $('#circle4').circleProgress({
      ...
      $(this).find('strong').html('<img src="assets/icon/php-svgrepo-com.svg">');
  });
    ...
    $('#circle5').circleProgress({
        ...
        $(this).find('strong').html('<img src="assets/icon/mysql-logo-svgrepo-com.svg">');
    });
    ...
    $('#circle6').circleProgress({
        ...
        $(this).find('strong').html('<img src="assets/icon/python-svgrepo-com.svg">');
    });
    ...
    $('#circle7').circleProgress({
        ...
        $(this).find('strong').html('<img src="assets/icon/teamwork-diagram-svgrepo-com.svg">');
    });
    ...
    $('#circle8').circleProgress({
        ...
        $(this).find('strong').html('<img src="assets/icon/english-svgrepo-com.svg">');
    });
